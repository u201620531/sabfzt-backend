...
class FormaPagoControllers {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const formaPagos = yield database_1.default.query("SELECT * FROM sabfztdb.`forma-pago`;");
            res.json(formaPagos);
        });
    }
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const formaPago = yield database_1.default.query("SELECT * FROM sabfztdb.`forma-pago` WHERE idFormaPago = ?;", [idFormaPago]);
