...
class EmpleadoControllers {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const empleadoes = yield database_1.default.query("SELECT EM.`idEmpleado`," +
                ...
                " EM.`fechaCreacion`," +
                " EM.`usuarioCreacion`" +
                " FROM `" + keys_1.default.database.database + "`.`empleado` AS EM" +
                " INNER JOIN `" + keys_1.default.database.database + "`.`soporte` AS CEM ON EM.`idCargo` = CEM.valor AND CEM.idSoporte='CEM';");
            res.json(empleadoes);
        });
    }
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const empleado = yield database_1.default.query("SELECT * FROM `" + keys_1.default.database.database + "`.`empleado` WHERE idEmpleado = ?;", [idEmpleado]);
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let id_number = 1;
                const getMaxId = yield database_1.default.query("SELECT COUNT(*) idEmpleado FROM `" + keys_1.default.database.database + "`.`empleado`;");
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { idEmpleado } = req.params;
                yield database_1.default.query("UPDATE `" + keys_1.default.database.database + "`.`empleado` SET ? WHERE idEmpleado = ?;", [req.body, idEmpleado]);
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { idEmpleado } = req.params;
                yield database_1.default.query("DELETE FROM `" + keys_1.default.database.database + "`.`empleado` WHERE idEmpleado = ?;", [idEmpleado]);
