...
class SoportesController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const formatTypes = yield database_1.default.query("SELECT * FROM `sabfztdb`.`soporte`;");
    ...
    getByidSoporte(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const formatType = yield database_1.default.query("SELECT * FROM `sabfztdb`.`soporte` WHERE idSoporte = ?;", [idSoporte]);
    ...
    getByidSoporteAndValue(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const formatType = yield database_1.default.query("SELECT * FROM `sabfztdb`.`soporte` WHERE idSoporte = ? AND valor = ?;", [idSoporte, valor]);
                if (formatType.length > 0) {
                    res.json(formatType);
                }
                else {
...
const soportesController = new SoportesController();
exports.default = soportesController;
