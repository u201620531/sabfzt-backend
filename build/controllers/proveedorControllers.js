...
class ProveedorControllers {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const proveedores = yield database_1.default.query("SELECT PV.`idProveedor`," +
                ...
                " PV.`fechaCreacion`," +
                " PV.`usuarioCreacion`" +
                " FROM `" + keys_1.default.database.database + "`.`proveedor` AS PV" +
                " INNER JOIN `" + keys_1.default.database.database + "`.`soporte` AS TPV ON PV.`idTipoProveedor` = TPV.valor AND TPV.idSoporte='TPV'" +
                " INNER JOIN `" + keys_1.default.database.database + "`.`soporte` AS TDP ON PV.`idTipoDocumento` = TDP.valor AND TDP.idSoporte='TDP';");
    ...
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const proveedor = yield database_1.default.query("SELECT * FROM `" + keys_1.default.database.database + "`.`proveedor` WHERE idProveedor = ?;", [idProveedor]);
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let id_number = 1;
                const getMaxId = yield database_1.default.query("SELECT COUNT(*) idProveedor FROM `" + keys_1.default.database.database + "`.`proveedor` WHERE `proveedor`.`idTipoProveedor` = ?;", [req.body.idTipoProveedor]);
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { idProveedor } = req.params;
                yield database_1.default.query("UPDATE `" + keys_1.default.database.database + "`.`proveedor` SET ? WHERE idProveedor = ?;", [req.body, idProveedor]);
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { idProveedor } = req.params;
                yield database_1.default.query("DELETE FROM `" + keys_1.default.database.database + "`.`proveedor` WHERE idProveedor = ?;", [idProveedor]);
