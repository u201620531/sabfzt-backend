...
class MonedaControllers {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const monedas = yield database_1.default.query("SELECT * FROM sabfztdb.`moneda`;");
            res.json(monedas);
        });
    }
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const moneda = yield database_1.default.query("SELECT * FROM sabfztdb.`moneda` WHERE idMoneda = ?;", [idMoneda]);
                if (moneda.length > 0) {
                    res.json(moneda[0]);
                }
                else {
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield database_1.default.query("INSERT INTO `sabfztdb`.`moneda` set ?", [
                    req.body,
                ]);
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { idMoneda } = req.params;
                yield database_1.default.query("UPDATE `sabfztdb`.`moneda` SET ? WHERE idMoneda = ?;", [
                    req.body,
                    idMoneda,
                ]);
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { idMoneda } = req.params;
                yield database_1.default.query("DELETE FROM `sabfztdb`.`moneda` WHERE idMoneda = ?;", [
                    idMoneda,
                ]);
