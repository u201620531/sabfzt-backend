  ...
  public async create(req: Request, res: Response): Promise<void> {
    try {
      ...
      const getMaxId = await pool.query(
        "SELECT COUNT(*) idProveedor FROM `" +
          keys.database.database +
          "`.`proveedor` WHERE `proveedor`.`idTipoProveedor` = ?;",
      ...
      await pool.query(
        "INSERT INTO `" + keys.database.database + "`.`proveedor` set ?",
        [req.body]
      );
  ...
  public async update(req: Request, res: Response): Promise<void> {
    try {
      ...
      await pool.query(
        "UPDATE `" +
          keys.database.database +
          "`.`proveedor` SET ? WHERE idProveedor = ?;",
